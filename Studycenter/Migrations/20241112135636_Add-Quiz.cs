        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumbersOfCorrectAnswers = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentQuiz", x => x.StudentQuizId);
                    table.ForeignKey(
                        name: "FK_StudentQuiz_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "QuizId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentQuiz_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAnswers_AnswerOptions_SelectedAnswerOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAnswerResult", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentAnswerResult_QuizResults_QuizResultId",
                        column: x => x.QuizResultId,
                        principalTable: "QuizResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentAnswerResult_StudentAnswers_StudentAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswerResult_QuizResultId",
                table: "StudentAnswerResult",
                column: "QuizResultId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswerResult_StudentAnswerId",
                table: "StudentAnswerResult",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_SelectedAnswerOptionId",
                table: "StudentAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentQuiz_QuizId",
                table: "StudentQuiz",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentQuiz_StudentId",
                table: "StudentQuiz",
                column: "StudentId");
        }
