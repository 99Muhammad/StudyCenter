...
namespace SCMS_back_end.Migrations
{
    ...
    [Migration("20241123060850_update-course-studentCourse-certificate-context")]
    partial class updatecoursestudentCoursecertificatecontext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCMS_back_end.Models.QuizResult", b =>
                {
                    ...
                    b.Property<int>("NumbersOfCorrectAnswers")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCMS_back_end.Models.StudentAnswerResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCMS_back_end.Models.StudentCourse", b =>
                {
                    ...
                    b.Property<int>("AssignmentsScore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCMS_back_end.Models.StudentQuiz", b =>
                {
            ...
            modelBuilder.Entity("SCMS_back_end.Models.Certificate", b =>
                {
                    b.HasOne("SCMS_back_end.Models.StudentCourse", "StudentCourse")
                        .WithOne("Certificate")
                        .HasForeignKey("SCMS_back_end.Models.Certificate", "StudentCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SCMS_back_end.Models.StudentAnswerResult", b =>
                {
                    b.HasOne("SCMS_back_end.Models.QuizResult", "QuizResult")
                        .WithMany("Answers")
                        .HasForeignKey("QuizResultId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SCMS_back_end.Models.StudentAnswer", "StudentAnswer")
                        .WithOne("StudentAnswerResult")
                        .HasForeignKey("SCMS_back_end.Models.StudentAnswerResult", "StudentAnswerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SCMS_back_end.Models.StudentAnswer", b =>
                {
                    b.Navigation("StudentAnswerResult");
                });
